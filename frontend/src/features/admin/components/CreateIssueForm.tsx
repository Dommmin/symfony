    ...
    return (
        <div className="mx-auto max-w-2xl space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Wypełnij formularz, aby utworzyć nowe zgłoszenie</p>
            </div>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea placeholder="Opisz problem szczegółowo" className="min-h-[100px]" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <div className="flex justify-end gap-4">
                        <Button type="button" variant="outline" onClick={() => navigate('/admin/issues')}>
                            Anuluj
                        </Button>
